...
public class TestCase10_AddRemoveQuantities extends BaseClass
{
	@Test
	public void TC10_AddRemoveQuantities_FromCart() throws EncryptedDocumentException, IOException
	{
		...
		String addedToCartText=prodPage.addToCart();
		Reporter.log("Cart success text: "+addedToCartText);
		a.assertEquals(addedToCartText, "Added to cart","text not matched");
		prodPage.GotoCart();
		ShopingCartPage cartPage= new ShopingCartPage(driver);
		a.assertTrue(cartPage.validateUserIsOnCartPage(),"User not navigated to cart page");
